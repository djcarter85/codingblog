...
## state as you go along TODO better title

output is nice enough but would be nice to see the algoriyjm at work.
yunfortunatelyt it's buried in the middel of the code

but immutability is good here because we dpo't have to chaneg mych to keep track
of all the outputs at each step. Can even store which cell was being done at
each stage
...
TODO maybe remove this if we already have an animated gif
