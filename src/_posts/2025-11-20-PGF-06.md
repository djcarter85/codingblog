...
I'll demonstrate the algorithm using an example on a smaller grid.
...
Now seems like a good time to introduce the concept of a _random walk_. A random
walk is a sequence of random steps within some state space.
...
sequence of numbers you end up with is a random walk through the integers.
...
different states, until we've walked all the way back to the start and our maze
is complete.
...
instance of `T`, and a function which gives us the distribution of the next step
