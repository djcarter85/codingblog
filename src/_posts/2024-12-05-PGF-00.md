...
![Procedurally generated village](/assets/images/2024-12-05-PGF-00/village.png)

[Functional programming
(FP)](https://en.wikipedia.org/wiki/Functional_programming) is a programming
paradigm which centres on the idea of composing functions. It is often viewed in
contrast to _imperative programming_, where successive statements update the
...
At first glance it might seem odd to combine procgen and FP. Randomness is an
inherently impure concept; by definition, you don't always get the same answer
when you ask for a random number! However, there are indeed ways of expressing
randomness in a functional way (as we shall see), and I'm intrigued to see
whether we're able to reap the benefits of functional principles within an
intrinsically random system.
